...
<template>
  ...
  <div id="chatContainer" ref="chats" style="left:3vw;position:absolute;height:90%;width:90%;overflow-x:hidden;overflow-y:auto;top:1%;padding-top:2vh;padding-bottom:2vh;color:white;" @scroll="onscroll">
    ...
    <div v-for="chat in timeline" id="chatBlock" :key="chat.username" style="margin-bottom:2.5%;position:relative;left:2%;">
      ...
      <div id="timeBlk" style="position:absolute;right:4%;font-size: 3.7vh;font-family:font3;font-weight:900;opacity:0.5;bottom:0;/* height:4vh; */">25:61 <br>PM</div>
    </div>
  </div>
...
<div id="channelAdd" class='channelAdd' style="position: absolute; right: -3%; font-size: 4vh; top: 84%; width: 13vw; height: 6%; background: white;cursor:pointer;overflow:hidden;">
      ...
      <div style='position: absolute; color: black; font-size: 2vh; font-family: font6; text-align: right; left: 0px; width: 87%;top: 53%;'>Add a Chat</div>
      <div style='font-family: font2; right: 0px; position: absolute; width: 100%; text-align: right; height: 100%; text-transform: uppercase; color: black; opacity: 0.2; font-weight: 900; padding-right: 1vw;top: 23.3%;top:-1vh;right:-5%;'>追加</div>
      <i class="fa fa-plus-circle chatClose" aria-hidden="true" style='position:absolute;color:rgba(0,0,0,0.8);font-size:5vh;top:30%;right:-5%;'></i>
