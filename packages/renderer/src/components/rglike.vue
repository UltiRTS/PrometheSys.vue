        ...
        <div
          ...
          <div
            ...
            <div style="position:absolute;top:1%;left:-10%;font-size:12vh;font-weight:900;font-family:font5;"><span
                style="color:#6c6c6c99;">0</span>2 <div
        ...
        <div style="position:absolute;transform:skew(-19deg);background:#423e38;height:176vh;width:137vh;">
          ...
          <div v-if="!rglkDetail"
            ...
            <div style="position:absolute;font-size:1.1vw;color:#ffffff87;top:52%;font-family:font5;left:4%;width:90%;">
              ...
              choose to go on without you. In the next dislogue, you will be asked to join or created a new test </div>
          </div>
          <div  v-if="!rglkDetail"
          ...
          <div  v-if="rglkDetail"
            ...
            <div class="rglkstripe"
              ...
              <div  style="position:absolute;width:100%;height:40%;top:20%;overflow:hidden;">
                ...
                <img src="/imgs/angles-right-solid.svg" style="position:absolute;height: 170%;top: -35%;left: 14%;"><img
                  src="/imgs/angles-right-solid.svg" style="position:absolute;height: 170%;top: -35%;left: 28%;"><img
                  src="/imgs/angles-right-solid.svg" style="position:absolute;height: 170%;top: -35%;left: 42%;"><img
                  src="/imgs/angles-right-solid.svg" style="position:absolute;height: 170%;top: -35%;left: 56%;"><img
                  src="/imgs/angles-right-solid.svg" style="position:absolute;height: 170%;top: -35%;left: 70%;"><img
            ...
            <div style="position:absolute;height:43%;width:2%;background:#ffcc31;top:6%;"></div>
            <div style="position:absolute;font-size: 2vw;color: #ffffff24;top: 8%;font-family:font10;left:4%;">TESTING
              IN</div>
            <div style="position:absolute;font-size:4vw;color: #ffffff59;top: 17%;font-family:font10;left:4%;">PROGRESS
            </div>
            <div style="position:absolute;font-size:2vw;color:#000000b3;top: 59%;font-family:font10;left:25%;background:white;mix-blend-mode:screen;width:45%;text-align:center;/* border-style:solid; */border-color:black;border-width:2vh;" @click="forfeit"> FORFEIT</div>
